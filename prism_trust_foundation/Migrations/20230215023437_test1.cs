        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminRole = table.Column<bool>(name: "Admin_Role", type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TimeslotId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShiftStart = table.Column<int>(name: "Shift_Start", type: "int", nullable: false),
                    ShiftEnd = table.Column<int>(name: "Shift_End", type: "int", nullable: false),
                    ShiftQuantity = table.Column<int>(name: "Shift_Quantity", type: "int", nullable: false),
                    ShiftType = table.Column<string>(name: "Shift_Type", type: "nvarchar(max)", nullable: false),
                    EventId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TimeslotBookingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeslotBooking", x => x.TimeslotBookingId);
                });
