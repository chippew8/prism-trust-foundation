        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Admin_Role = table.Column<bool>(type: "bit", nullable: true),
                    Ban_Status = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    dRecip_Role = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coupon_Name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Percentage_Discount = table.Column<int>(type: "int", nullable: false),
                    Expiry_Date = table.Column<DateTime>(type: "date", nullable: false),
                    Total_Coupon_Redeemed = table.Column<int>(type: "int", nullable: false),
                    Total_Coupon_Quantity = table.Column<int>(type: "int", nullable: false),
                    Current_Coupon_Quantity = table.Column<int>(type: "int", nullable: false),
                    Points_to_redeem = table.Column<int>(type: "int", nullable: false),
                    ImageURL = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_donationRecipients", x => x.email);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Question", x => x.QueryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Shift_Start = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shift_End = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shift_Quantity = table.Column<double>(type: "float", maxLength: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CouponRedemptionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Date_of_Redemption = table.Column<DateTime>(type: "date", nullable: false),
                    CouponId = table.Column<string>(type: "nvarchar(5)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
